...
#user label
usernpl=ub.user(12333334,"Fechfecha","fechfecha") 
...
def changedata():
    args={"newpassword":password.get(),"username":username.get(),"confirmpassword":password2.get(),"label1":user,"label2":pas}
    usernpl.updateprofile(args)
def dash_butt():
...
#buttons
save= Button(window,width=8, text='Save', font=('Abel',15),fg='white',bg='#2C49A0',command=changedata).place(x=1500,y=850)
