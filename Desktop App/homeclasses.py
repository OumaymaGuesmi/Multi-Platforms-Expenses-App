...
def popup_bonus1():
    ...
    def addCategory():
        ...
        def popup_bonuscat():
            ...
            def changeData():
                ...
                newField.addvalue(k)
                plsValue.config(text=str(total)+'$')
    ...
    b1 = ttk.Button(win1, text="gg", command=addCategory)
